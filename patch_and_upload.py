...
def apply_patches(html):
    ...
    patches.append((
        ...
        f'                <img src="data:image/png;base64,{shield_b64}" style="height:52px;width:auto;filter:drop-shadow(0 4px 6px rgba(0,0,0,0.6))" alt=""/>\n                <h1 class="stencil-shadow text-xl" style="color: var(--yellow)">БОЙОВІ ЗВІТИ</h1>',
        'shield-logo'
    ))
