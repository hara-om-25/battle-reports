...
def apply_patches(html):
    ...
    patches.append((
        ...
        'onmousedown="this.style.transform=\'translateY(calc(-50% + 2px))\';this.style.boxShadow=\'0 2px 0 #2d3818\'" '
        ...
        'class="btn-stencil" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);padding:4px 8px;font-size:12px" title="Вставити з буфера">&#x2B06;</button>\n'
        '                        </div>',
    ...
    patches.append((
        ...
        'ontouchend="this.style.transform=\'translateY(-50%)\';this.style.boxShadow=\'\'" '
        'class="btn-stencil btn-green" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);padding:4px 8px;font-size:12px">+</button>\n'
        '                        </div>\n'
        '                    </div>\n'
        '                </div>',
