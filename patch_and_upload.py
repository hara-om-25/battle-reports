...
def apply_patches(html):
    ...
    patches.append((
        ...
        'ontouchstart="this.style.background=\'#9a9070\';this.style.transform=\'translateY(2px)\'" '
        'ontouchend="this.style.background=\'\';this.style.transform=\'\'" '
        'class="btn-stencil" style="padding:0;font-size:16px;flex-shrink:0;width:42px;align-self:stretch;margin-top:1px;margin-bottom:1px" title="Вставити з буфера">&#x2398;</button>\n'
        '                        </div>',
